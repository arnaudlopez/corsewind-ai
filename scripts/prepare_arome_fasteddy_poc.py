...
def write_parent_schema(plan: dict[str, Any], output_root: Path) -> None:
    schema = {
        ...
        "variables": {
            ...
            "landcover_class": "2D ESA WorldCover categorical land-cover class",
            "landmask": "2D land/sea mask derived from land cover, with DEM fallback for unknown classes",
            "z0m": "2D momentum roughness length derived from land-cover class lookup",
            "u": "4D eastward wind",
            "v": "4D northward wind",
            ...
            "surface_pressure": "2D ground/surface pressure when AROME P__GROUND is available",
        },
